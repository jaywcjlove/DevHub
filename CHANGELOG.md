...
1. fix: fix CodeMirror editor theme setting
2. perf: optimize editor performance issues

## [v1.46.0](https://github.com/jaywcjlove/DevHub/releases/tag/v1.46.0)

1. feat: add HTML to Markdown tool

## [v1.45.0](https://github.com/jaywcjlove/DevHub/releases/tag/v1.45.0)

1. feat: Add text to NATO phonetic alphabet tool
